...
if($offer_cat != ''){
	...
	if(isset($_POST['main_settings'])) $prompt='<div class="updated" style="margin-top:-10px !important"><p>'.__( 'Reservations dashboard settings saved' , 'easyReservations' ).'</p></div>';
...
/* - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + BULK ACTIONS (trash,delete,undo trash) + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + */
	...
	if(isset($_GET['bulk']) && check_admin_referer( 'easy-main-bulk', 'easy-main-bulk' )){ // GET Bulk Actions
		if(isset($_GET['bulkArr'])) {
			...
			$prompt='<div class="updated" style="margin-top:-10px !important"><p>'.$anzahl.' '.__( 'moved to trash' , 'easyReservations' ).'. <a href="'.wp_nonce_url('admin.php?page=reservations&bulkArr[]='.$linkundo.'&bulk=2', 'easy-main-bulk').'">'.__( 'Undo' , 'easyReservations' ).'</a></p></div>';
			...
			if($to==1) { $anzahl=__('Reservation', 'easyReservations'); } else { $anzahl=$to.' '.__('Reservations', 'easyReservations');  }
			$prompt='<div class="updated" style="margin-top:-10px !important"><p>'.$anzahl.' '.__( 'restored from trash' , 'easyReservations' ).'</p></div>';
			...
			if($to==1){ $anzahl=__('Reservation', 'easyReservations'); } else { $anzahl=$to.' '.__('Reservations', 'easyReservations');  }
			$prompt='<div class="updated" style="margin-top:-10px !important"><p>'.$anzahl.' '.__('deleted permanently', 'easyReservations').'</p></div>';
			}
		}
	}
...
/* - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + DELETE CUSTOM FIELD + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + */
	...
	if(isset($deletecustomfield)){
		...
		$prompt='<div class="updated" style="margin-top:-10px !important"><p>'.__( 'Custom field deleted' , 'easyReservations' ).'</p></div>';
	}
...
/* - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + DELETE PRICE FIELD + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + */
	...
	if(isset($deletepricefield)){
		...
		$prompt='<div class="updated" style="margin-top:-10px !important"><p>'.__( 'Custom price field deleted' , 'easyReservations' ).'</p></div>';
	}
...
/* - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + EDIT RESERVATION BY ADMIN + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + */
	...
	if(isset($editthereservation) && check_admin_referer( 'easy-main-edit', 'easy-main-edit' )){
		...
		if($errors > 0){
			$prompt='<div class="error" style="margin-top:-10px !important"><p>'.__( 'Depature before arrival or roomcount too high' , 'easyReservations' ).'</p></div>';
		} elseif($moneyerrors > 0){
			$prompt='<div class="error" style="margin-top:-10px !important"><p>'.__( 'Wrong money formatting' , 'easyReservations' ).'</p></div>';
		} elseif(easyreservations_check_avail($EDITroom, $timestampstartedit, $EDITroomex, $calcdaysbetween, 0, 0, $edit, 0) > 0){
			$prompt='<div class="error" style="margin-top:-10px !important"><p>'.__( 'Selected Room is occupied at this date' , 'easyReservations' ).'</p></div>';
		} else {
			...
			$prompt='<div class="updated" style="margin-top:-10px !important"><p>'.__( 'Reservation edited!' , 'easyReservations' ).'</p></div>';
		}
	}
/* - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + ADD RESERVATION BY ADMIN + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + */
	...
	if(isset($addreservation) && check_admin_referer( 'easy-main-add', 'easy-main-add' )){
		...
		if($errors != ""){
			$prompt='<div class="error" style="margin-top:-10px !important"><p>'.__( 'Please fill out all Fields' , 'easyReservations' ).' - '.$errors.'</p></div>';
			...
			$prompt='<div class="updated" style="margin-top:-10px !important"><p>'.__( 'Reservation has been added' , 'easyReservations' ).'</p></div>';
			...
			if(isset($_POST["fixReservation"]) && $_POST["fixReservation"] == "on"){
				...
				else $prompt.='<div class="error" style="margin-top:-10px !important"><p>'.__( 'Price couldnt be fixed, input wasnt money' , 'easyReservations' ).'</p></div>';
			}
...
/* - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + GET INFORMATIONS IF A RESERVATION IS CALLED DIRECTLY (view,edit,approve,reject,sendmail) + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + */
	...
	if(isset($approve)  || isset($delete) || isset($view) || isset($edit) || isset($sendmail)) { //Query of View Reject Edit Sendmail and Approve
		...
		if(!empty($exactlyroom) && $exactlyroom > 0 && $exactlyroom > $roomcount) $prompt='<div class="error" style="margin-top:-10px !important"><p>'.__( 'Exactly room is above roomcount' , 'easyReservations' ).'</p></div>';
	...
	if(isset($sendmail) AND isset($_POST['thesendmail'])){
		...
		easyreservations_send_mail($emailformation, $mail_to, $subj, $approve_message, $id, $res_date_from_stamp, $timestampend, $name, $mail_to, $reservationNights, $persons, $childs, $country, $room_name, $specials, $customs, easyreservations_get_price($approve), $message_r, '');
		$prompt='<div class="updated" style="margin-top:-10px !important"><p>'.__( 'eMail sent successfully' , 'easyReservations' ).'</p></div>';
	}
	...
	if(isset($post_approve) && $post_approve=="yes"){
		...
		if(easyreservations_check_avail($room, $res_date_from_stamp, $roomexactly, $reservationNights, 0, 0, $id) == 0){
			...
			$prompt='<div class="updated" style="margin-top:-10px !important"><p> '.__( 'Reservation approved' , 'easyReservations' ).'</p></div>';
	...
	if(isset($post_delete) && $post_delete=="yes"){
		...
		$prompt='<div class="updated" style="margin-top:-10px !important"><p>'.$anzahl.' '.__( 'Reservations rejected' , 'easyReservations' ).'</p></div>';
		?><meta http-equiv="refresh" content="0; url=admin.php?page=reservations"><?php
