...
/* - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + DELETE CUSTOM FIELD + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + */
	...
	if(isset($deletecustomfield)){
		...
		foreach($filterouts as $customs){
			$countthem++;
			if($countthem==$deletecustomfield){
				$theminzs = $customs.'&;&';
				break;
			}
		}
		$finishedcustom=preg_replace('/'.$theminzs.'/', "", $customquerie[0]->custom, 1);
		$wpdb->query($wpdb->prepare("UPDATE ".$wpdb->prefix ."reservations SET custom='$finishedcustom' WHERE id='$edit' "));
		$prompt='<div class="updated" style="margin-top:-5px !important"><p>'.__( 'Custom field deleted' , 'easyReservations' ).'</p></div>';
	}
...
/* - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + DELETE PRICE FIELD + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + */
	...
	if(isset($deletepricefield)){
		...
		foreach($filteroutx as $customps){
			$countthemp++;
			if($countthemp==$deletepricefield){
				$theminzps = $customps.'&;&';
				break;
			}
		}
		$finishedcustomp=preg_replace('/'.$theminzps.'/', "", $custompquerie[0]->customp, 1);
		$wpdb->query($wpdb->prepare("UPDATE ".$wpdb->prefix ."reservations SET customp='$finishedcustomp' WHERE id='$edit' "));
		$prompt='<div class="updated" style="margin-top:-5px !important"><p>'.__( 'Custom price field deleted' , 'easyReservations' ).'</p></div>';
	}
...
/* - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + EDIT RESERVATION BY ADMIN + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + */
	...
	if(isset($editthereservation) && check_admin_referer( 'easy-main-edit', 'easy-main-edit' )){
		...
		for($theCount = 1; $theCount < 21; $theCount++){
		...
		if($errors > 0){
		...
		} elseif(easyreservations_check_avail($EDITroom, $timestampstartedit, $EDITroomex, $calcdaysbetween, 0, 0, $edit, 0) > 0){
			...
			$wpdb->query($wpdb->prepare("UPDATE ".$wpdb->prefix ."reservations SET arrivalDate='$rightdate', nights='$calcdaysbetween', name='$name', email='$email', notes='$note', room='$EDITroom', number='$persons', childs='$childs', special='$specialoffer', dat='$dat', roomnumber='$EDITroomex', price='$settepricei', custom='$customfields', customp='$custompfields', approve='$EDITreservationStatus', country='$country', reservated='$reservation_date_sql' WHERE id='$edit' "));
			...
			if(isset($sendthemail) AND $sendthemail=="on"){
				...
				if($emailformation['active'] == 1) easyreservations_send_mail($emailformation['msg'], $email, $emailformation['subj'], $approve_message, $edit, $timestampstartedit, $timestampendedit, $name, $email, $calcdaysbetween, $persons, $childs, $country, get_the_title($EDITroom), $theMailOffer, $customfields, easyreservations_get_price($edit), $note, $changelog);
			}
...
/* - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + ADD RESERVATION BY ADMIN + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + */
	...
	if(isset($addreservation) && check_admin_referer( 'easy-main-add', 'easy-main-add' )){
		...
		for($theCount = 1; $theCount < 21; $theCount++){
			if(isset($_POST["customPvalue".$theCount]) AND isset($_POST["customPtitle".$theCount])){
				if(easyreservations_check_price($_POST["custom_price".$theCount]) == 'error') $moneyerrors++;
				$ADDcustompFields.= $_POST["customPtitle".$theCount].'&:&'.$_POST["customPvalue".$theCount].':'.easyreservations_check_price($_POST["custom_price".$theCount]) .'&;&';
			}
		}
		...
		if($errors != ""){
		...
		} elseif(easyreservations_check_avail($ADDroom, $ADDtimestampsanf, $ADDroomex, $ADDanznights, 0, 0, '', 0) > 0){
			$prompt='<div class="error" style="margin-top:-5px !important"><p>'.__( 'Selected Room is occupied at this Date' , 'easyReservations' ).'</p></div>';
		} elseif($moneyerrors > 0){
			$prompt='<div class="error" style="margin-top:-5px !important"><p>'.__( 'Wrong money formatting' , 'easyReservations' ).'</p></div>';
		}else {
			...
			VALUES ('$ADDrightdate', '$ADDname', '$ADDemail', '$ADDnote', '$ADDanznights', '$ADDdat', '$ADDroom', '$ADDroomex', '$ADDpersons', '$ADDchilds', '$ADDcountry', '$ADDspecialoffer', '$ADDstatus', '$ADDcustomFields', '$ADDcustompFields', '$ADDreservation_date_sql'  )"  ) ); 
...
/* - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + GET INFORMATIONS IF A RESERVATION IS CALLED DIRECTLY (view,edit,approve,reject,sendmail) + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + - + */
	...
	if(isset($approve)  || isset($delete) || isset($view) || isset($edit) || isset($sendmail)) { //Query of View Reject Edit Sendmail and Approve
		...
		$sql_approvequerie = "SELECT id, name, approve, nights, arrivalDate, room, special, roomnumber, number, childs, country, email, custom, customp, notes, price, reservated FROM ".$wpdb->prefix ."reservations WHERE id='$theIDofRes'";
		...
		$reservated=date("d.m.Y", strtotime($approvequerie[0]->reservated));
	...
	if(isset($sendmail) AND isset($_POST['thesendmail'])){
		...
		if($emailformation['active'] == 1) easyreservations_send_mail($emailformation['msg'], $mail_to, $emailformation['subj'], $approve_message, $id, $res_date_from_stamp, $timestampend, $name, $mail_to, $reservationNights, $persons, $childs, $country, $room_name, $specials, $customs, easyreservations_get_price($approve), $message_r, '');
...
if(!isset($approve) && !isset($delete) && !isset($view) && !isset($edit) && !isset($sendmail) && !isset($add)){
	...
	<?php } ?>
		...
		<table  class="<?php echo RESERVATIONS_STYLE; ?>" style="width:10%; float:left;margin:0px 10px 10px 0px;clear:none;">
			<thead>
				<tr>
					<th>
		...
		<?php
			...
			$all_rooms = easyreservations_get_rooms(0,1);
			$rooms = 0;
		...
		<table class="<?php echo RESERVATIONS_STYLE; ?>" <?php if(isset($width)) echo $width; ?>>
			...
			<?php if(isset($view)){ ?>
				...
				<tr class="alternate">
					...
					<td><b><?php echo date("d.m.Y",$res_date_from_stamp);?> - <?php echo date("d.m.Y",$timestampend);?> <small>(<?php echo $reservationNights;?>)</small></b></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><b><?php echo __($room_name); ?></b></td>
				</tr>
...
if(isset($edit)){
	...
	foreach($customsmerges as $customprice){
		...
		$customfields .= '<td><b><input type="text" name="customPvalue'.$thenumber2.'" value="'.$priceexpexplode[0].'" style="width:200px"><input type="text" name="custom_price'.$thenumber2.'" id="custom_price'.$thenumber2.'" onchange="easyreservations_send_price_admin();" value="'.$priceexpexplode[1].'" style="width:70px;"></b> &'.get_option("reservations_currency").';</td></tr>';
	}
?><script>
...
<?php add_action('wp_print_footer_scripts', 'easyreservtions_send_price_script');
}
		...
		<td valign="top">
			<table class="<?php echo RESERVATIONS_STYLE; ?>" style="width:248px;margin-bottom:4px;">
				...
				<tbody>
					...
					<tr>
						<td nowrap><?php printf ( __( 'Reservated' , 'easyReservations' ));?></td>
						<td nowrap style="text-align:right"><input type="text" name="reservation_date" id="reservation_date" style="width:73px" value="<?php echo date("d.m.Y", time()); ?>"></td>
					</tr>
					<tr>
...

if(isset($sendmail)) {
	echo easyreservations_check_filter($sendmail);
