<?php
	function reservations_calendar_shortcode($atts) {
		...
		$return = '<form name="CalendarFormular" id="CalendarFormular" style="margin:0px !important;padding:0px !important;display:inline-block;width:'.$atts['width'].'%">';
		...
		$easyreservations_script .= ';var easyCalendarAtts='.json_encode($atts).';easyreservations_send_calendar("shortcode");';
