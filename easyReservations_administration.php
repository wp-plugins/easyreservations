			...
			<table class="widefat" style="width:100%;">
				...
				<tbody>
					...
					<table class="widefat">
						...
						<tbody>
								<tr valign="top">
									<td style="vertical-align:middle;"><?php printf ( __( 'Website for Plugin is online!' , 'easyReservations' ));?><br><?php printf ( __( 'With a Documentation, a Vote-System for future Features and a Contact Page' , 'easyReservations' ));?><br><b><a href="http://www.feryaz.de/">feryaz.de</a></b></td>
								</tr>
						</tbody>
					</table>
		</td></tr></table><br>
