...
function reservation_main_page() {
	...
	if(isset($approve)  || isset($delete) || isset($view) || isset($edit)) { //Query of View Reject and Approve
		...
		$approvequerie = $wpdb->get_results($sql_approvequerie );
			...
			if($approve) $edtlink='&approve='.$approve;
			if($delete) $edtlink='&delete='.$delete;
	}
...
<table cellspacing="0" style="width:99%">
	...
	<form method="post" action="admin.php?page=settings"  id="reservation_settingss">
		...
		<a href="javascript:{}" onclick="document.getElementById('reservation_settingss').submit(); return false;" class="button-primary" style="margin-left:auto;margin-rigth:auto;"><span><?php printf ( __( 'Save Changes' , 'easyReservations' ));?></span></a>
			...
			<tr valign="top">
				...
				<td style="width:40%;">
					<div class="explainbox">
						...
						<p><code class="codecolor">[hidden]</code> <i><?php printf ( __( 'for forms for just one Room' , 'easyReservations' ));?></i></p>
						<p style="margin-left:20px;"><code class="codecolor">x = ID</code> <i><?php printf ( __( 'ID of the Room Post' , 'easyReservations' )); echo reservations_get_room_ids();?></i></p>								
...
Name: [thename] <br>eMail: [email] <br>From: [arrivaldate] <br>To: [to] <br>Persons: [persons] <br>Persons: [persons] <br>Phone: [phone] <br>Address: [address] <br>Room: [room] <br>Offer: [offer] <br>Message: [message]";
	$emailstandart2="Your Reservation on Blogname has been approved.<br> <br>
[adminmessage]<br> <br>
Reservation Details:<br>
-----------------------<br>
Name: [thename] <br>eMail: [email] <br>From: [arrivaldate] <br>To: [to] <br>Persons: [persons] <br>Persons: [persons] <br>Phone: [phone] <br>Address: [address] <br>Room: [room] <br>Offer: [offer] <br>Message: [message]";
	$emailstandart3="Your Reservation on Blogname has been rejected.<br> <br>
[adminmessage]<br> <br>
Reservation Details:<br>
-----------------------<br>
Name: [thename] <br>eMail: [email] <br>From: [arrivaldate] <br>To: [to] <br>Persons: [persons] <br>Persons: [persons] <br>Phone: [phone] <br>Address: [address] <br>Room: [room] <br>Offer: [offer] <br>Message: [message]";
				...
				<tr>
					<td style="width:100%;" align="center">
						...
						<p><b style="font-size:13px">easyReservations Version 1.1</b><br>
								...
								<b>* NEW FUNCTION</b> <i>Statistis! Starts with three Charts, more to come.</i><br>
								...
								<b>* FIXED</b> <i>many minor bugs</i><br>
