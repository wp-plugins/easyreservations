<?php
	function easyreservations_resource_tutorial() {
		...
		$content = array(
			...
			'<h3>Child discount</h3><p>The price that gets subtracted by this amount and multiplied by the amount of children\'s if <b>Price per person</b> is enabled. Then the custom prices, conditional filters, coupons and taxes gets calculated.</p>',
		...
		$offset = array('-75 0','-75 0', '-100 0', '-75 0', '-75 0', '-65 0', '-75 0', '-75 0', '-70 0', '-50 0', '-66 0', '-66 0', '-75 0', '-75 0', '-75 0', '-75 0', '-75 0', '-75 0', '-75 0', '-75 0', '-75 0');
