<?php
	function easyreservations_resource_tutorial() {
		...
		$content = array(
			...
			'<h3>Child discount</h3><p>The price that gets subtracted by this amount and multiplied by the amount of children if <b>Price per person</b> is enabled. Then the custom prices, conditional filters, coupons and taxes gets calculated.</p>',
