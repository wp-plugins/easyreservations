<?php
	function easyreservations_dashboard_tutorial() {
		...
		$content = array(
				'<h3>Dashboard</h3><p>Welcome to easyReservations!<br>This is the reservations dashoard and you can add, edit and handle your reservations here.</p>',
				...
				'<h3>Overview</h3><p>The overview is the visual and interactive schedule of your buisness.</p>',
				...
				'<h3>Overviews cell</h3><p>You can select the date and resource of a reservation by clicking in the cells. If no reservation selected it will lead to add a new reservation. Many informations gets displayed visually in the cells. The background can be red for unavailable by filter, yellow for weekend and blue for today. Past days have a pattern in it. Reservations get displayed in four different colors for the time and if its active.</p>',
				'<h3>Second click</h3><p>To set the informations you have to click on a second cell in the same row.</p>', //10
				'<h3>Resource count</h3><p>Click on the resources count in approve or edit to change the resource without changing the days.</p>', //11
				...
				'<h3>Search</h3><p>Search for name, email, id or custom informations in your reservations.</p>',
				'<h3>Order by</h3><p>You can order the by the reservations by name, date, reserved and resource.</p>',
				'<h3>Favourite</h3><p>You can favourite reservations to find the better later on and rember them. They get saved per user, so nobody can see your favourites.</p>',
				'<h3>Bulk</h3><p>To trash, delete or restore multiple checked reservations at the same time.</p>',
				'<h3>Pagination</h3><p>If more reservations are in the same group then defined above they get seperated and you can navigate throught them here.</p>',
				'<h3>Today</h3><p>Here you can see who arrivals and departures today. The percatage value quantifys how much of your resources are reservated today.</p>',
		);
		...
		$at = array('left bottom', 'right bottom', 'left bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom', 'left bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom');
		echo '<br>';
