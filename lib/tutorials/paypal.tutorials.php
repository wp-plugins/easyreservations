<?php
	function easyreservations_paypal_tutorial() {
		...
		$content = array(
				'<h3>PayPal</h3><p>After turning on and setting an owner the <b>Buy now!</b> button will appear after successful reservations and at the user control panels status bar.</p>',
				...
				'<h3>Deposit</h3><p>With the deposit function you can let your guests only pay a part of the calculated price. You can let them choose to pay the full price, to pay a precentual amount or select from multiple or even let them choose the amount by themself.</p>',
		);
		$offset = array('-75 0', '-75 0', '-75 0', '-66 0');
		$at = array('center bottom', 'center bottom', 'center bottom', 'center bottom');
