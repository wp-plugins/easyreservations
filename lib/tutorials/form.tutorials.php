<?php
	function easyreservations_form_tutorial() {
		...
		$content = array(
				...
				'<h3>Times</h3><p>This select will allow your guests to select the hours/days/weeks to reservate as of the resources billing setting. Its an alternative to the depatures field <code class="codecolor">[date-to]</code> and they cant be used together.</p>',
				...
				'<h3>Custom prices</h3><p>Much like the custom fields, but with an impact on the price calculation. They can be radio buttons, selects or checkboxes. The amount can be multiplied by persons, times or both.</p>',
		...
		$at = array('center bottom', 'right bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom', 'center bottom');
