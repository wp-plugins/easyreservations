...
<div style="text-align:center;">[submit Send]</div>';
	...
	*/
	...
	function easyReservations_upgrade(){
		...
		$easyReservations_active_ver="1.3";
		...
		if($easyReservations_installed_ver != $easyReservations_active_ver ){
			...
			if($easyReservations_active_ver < 1.2){
				global $wpdb;
				$table_name = $wpdb->prefix . "reservations";
			...
			} elseif($easyReservations_active_ver == 1.2){
			...
			if($reservtionsTable == 1){
				update_option('reservations_db_version', '1.3');
	...
	function easyReservations_upgrade_notice(){
		echo '<div class="updated">
		   <p>Thanks for updating <b>easyReservations</b> to <b>1.3</b>!<br>View <a href="http://feryaz.de/changelog/">here</a> fore a detailed Changelog! If u cant see anythink on main page use the sceen options button in the upper right!</p>
		</div>';
	}
