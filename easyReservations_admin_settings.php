...
function jumpto(x){ // Chained inputs;
	...
	if(thetext1 == false){
		...
		if (x == "textarea" || x == "text" || x == "check"){
			var Output  = '<input type="text" name="zwei" id="zwei" value="Name"> <input type="checkbox" id="drei" name="drei" value="*"> <?php echo __( 'Necessary' , 'easyReservations' ); ?> ';
		...
		if (x == "Name") {
			...
			if(first == "custom") Output += ' <input type="checkbox" id="req" name="req" value="*"> <?php echo __( 'Necessary' , 'easyReservations' ); ?> ';
			document.getElementById("Text3").innerHTML += Output;
			thetext3 = true;
		}
	}
