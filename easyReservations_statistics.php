...
function reservation_statistics_page() { //Statistic Page
		...
		while( $nr < 20) {
			...
			$lol=date("Y-m-d", $date);
				...
				$sql_A = "SELECT * FROM ".$wpdb->prefix ."reservations WHERE approve='yes' AND '$lol' BETWEEN arrivalDate AND DATE_ADD(arrivalDate, INTERVAL nights DAY) - INTERVAL 1 DAY";
		...
		while( $nr < 365*2) {
			...
			$priceperreservation=$pricesall/$countallreservations;
?>
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				function createDetail(masterChart) {
					...
					var detailData = [],
						detailStart = Date.UTC(2012, 11, 30);
			...
			<tr>
				...
				<td style="width: 29%;">
					<table class="widefat" style="width: 100%;" >
						<thead>
							<tr>
								<th><?php printf ( __( 'Detailed Statistics' , 'easyReservations' ));?></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td style="">
									<p style="font-size:13px;padding: 0 5px 0 5px"><?php printf ( __( 'Total Reservations' , 'easyReservations' ));?>: <b><?php echo $countallreservationsall; ?> </b></p>
									<p style="font-size:13px;padding: 0 5px 0 5px">- <?php printf ( __( 'Future approved Reservations' , 'easyReservations' ));?>: <b><?php echo $countallreservationsfuture; ?></b></p>
									<p style="font-size:13px;padding: 0 5px 0 5px">- <?php printf ( __( 'Past approved Reservations' , 'easyReservations' ));?>: <b><?php echo $countallreservationspast; ?></b></p>
									<p style="font-size:13px;padding: 0 5px 0 5px">- <?php printf ( __( 'Pending Reservations' , 'easyReservations' ));?>: <b><?php echo $countallreservationspending; ?></b></p>
									<p style="font-size:13px;padding: 0 5px 0 5px">- <?php printf ( __( 'Rejected Reservations' , 'easyReservations' ));?>: <b><?php echo $countallreservationsreject; ?></b></p>
									<p style="font-size:13px;padding: 0 5px 0 5px">- <?php printf ( __( 'Trashed Reservations' , 'easyReservations' ));?>: <b><?php echo $countallreservationstrash; ?></b></p>
									<p style="font-size:13px;padding: 0 5px 0 5px">	&#216; <?php printf ( __( 'Guests per Reservation' , 'easyReservations' ));?>: <b><?php echo round($personsperreservation, 2); ?></b></p>
									<p style="font-size:13px;padding: 0 5px 0 5px">	&#216; <?php printf ( __( 'Nights per Reservation' , 'easyReservations' ));?>: <b><?php echo round($nightsperreservation, 2); ?></b></p>
									<p style="font-size:13px;padding: 0 5px 0 5px">	<?php printf ( __( 'Revenue of all Reservations' , 'easyReservations' ));?>: <b><?php echo round($pricesall, 2).'&'.get_option('reservations_currency').';'; ; ?></b></p>
									<p style="font-size:13px;padding: 0 5px 0 5px">	- <?php printf ( __( 'Revenue of future Reservation' , 'easyReservations' ));?>: <b><?php echo round($pricesfuture, 2).'&'.get_option('reservations_currency').';'; ?></b></p>
									<p style="font-size:13px;padding: 0 5px 0 5px">	- <?php printf ( __( 'Revenue of past Reservation' , 'easyReservations' ));?>: <b><?php echo round($pricespast, 2).'&'.get_option('reservations_currency').';'; ?></b></p>
									<p style="font-size:13px;padding: 0 5px 0 5px">	&#216; <?php printf ( __( 'Revenue per Reservation' , 'easyReservations' ));?>: <b><?php echo round($priceperreservation, 2).'&'.get_option('reservations_currency').';'; ?></b></p>
								</td>
							</tr>
						</tbody>
					</table>
