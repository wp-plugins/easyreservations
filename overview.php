<?php
	...
	if($reservations_show_rooms == ''){
		$show_rooms=easyreservations_get_rooms();
		foreach($show_rooms as $show_room){
			$RoomsArray[] = $show_room->ID;
		}
	} else {
		...
		<thead>
			<tr>
				<th colspan="<?php echo $daysshow+1; ?>"  class="overviewHeadline">
					<span id="pickForm"><input name="dayPicker" id="dayPicker" type="hidden"></span> &nbsp;<b class="overviewDate"><?php echo $dateshow; ?></b><span id="ov_datefield"></span>
					<span style="float:right">
						<input name="daybutton" class="easySubmitButton-secondary" value="10" type="button" onclick="easyRes_sendReq_Overview('<?php echo $moregets; ?>','',10);resetSet();">
						<input name="daybutton" class="easySubmitButton-secondary" value="20" type="button" onclick="easyRes_sendReq_Overview('<?php echo $moregets; ?>','',20);resetSet();">
						<input name="daybutton" class="easySubmitButton-secondary" value="30" type="button" onclick="easyRes_sendReq_Overview('<?php echo $moregets; ?>','',30);resetSet();">
					</span>
				</th>
			</tr>
