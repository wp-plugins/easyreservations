...
function helpFilters()
{
  var Output  = "<div style='border:solid 1px #FFF141; padding: 3px; width:98%; ";
      ...
      Output += "<p><code>[pers]</code> <small>Set Discount for more Persons</small></p><p style='margin-left:15px;'><code style='background-color:#FF9393'>[condition]</code> <small>Number of Persons for Discount</small></p><p style='margin-left:15px;'><code style='background-color:#AAFFC5'>[value]</code> <small>Discount (XX or XX%)</small></p>";
