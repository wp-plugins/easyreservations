...
$formstandart.="
	...
	update_option('reservations_db_version', '1.1.1');
}
...
////////////////////////////////////////////////////////////////// END OF MAIN FUNTIONS /////////////////////////////////////////////////////////////
		...
		function reservations_get_offer_ids(){ //Get the IDs of the Rooms in XX, XX, XX for helping people to find it.
			global $wpdb;
