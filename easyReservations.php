...
function reservations_datepicker_load() {  //  Load Scripts and Styles for datepicker
        $myStyleUrl21 = WP_PLUGIN_URL . '/easyreservations/css/jquery-ui.css';
        $ScriptFile3 = WP_PLUGIN_URL . '/easyReservations/js/jquery.tools.min.js';

		wp_register_style('jquery-ui-csss', $myStyleUrl21);
		wp_register_script('jquerytools', $ScriptFile3);

		wp_enqueue_style( 'jquery-ui-csss');
		wp_enqueue_script('jquerytools');
...
function reservation_add_pages() {  //  Add Pages Admincenter and Order them
	...
	add_submenu_page('reservations', __('Statistics','menu-test'), __('Statistics','menu-test'), 'manage_options', 'statistics', 'reservation_statistics_page');
