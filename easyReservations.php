...
*/
	...
	function easyReservations_add_pages(){  //  Add Pages Admincenter and Order them
		...
		add_menu_page(__('easyReservation','easyReservations'), __('Reservations','easyReservations').' '.$pending, $reservation_main_permission, 'reservations', 'reservation_main_page', RESERVATIONS_IMAGES_DIR.'/logo.png' );
